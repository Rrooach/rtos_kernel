...
*                                        points to an object of type '_fd_set' that on input specifies the
...
*                                        points to an object of type '_fd_set' that on input specifies the file
...
*                                   ('p_timeout') of type struct '_timeval'" ... :
*
*                                   (a) "in seconds" ...
*                                   (b) "and microseconds."
*
